          ...
          <div className="flex items-center space-x-4 group cursor-pointer" onClick={() => (window.location.href = '#')}>
            <div className="flex flex-col">
                <span className="text-white text-xl font-black tracking-[0.2em] uppercase leading-none">
                    AKASH JADHAV<span className="text-blue-500 animate-pulse ml-0.5">.</span>
                </span>
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <div className="flex items-center space-x-6 border-l border-white/10 pl-10 h-6">
                ...
                <a 
                  ...
                  className="px-5 py-1.5 border border-white/20 text-white font-mono text-[9px] uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 rounded-sm inline-block"
                >
                    Hire Me
                </a>
            </div>
