...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FiGithub />, label: 'GITHUB', url: 'https://github.com/JadhavAkash8', color: 'hover:text-red-500' },
    { icon: <FiLinkedin />, label: 'LINKEDIN', url: 'https://www.linkedin.com/in/akash-jadhavv', color: 'hover:text-blue-500' },
    { icon: <FiInstagram />, label: 'INSTAGRAM', url: 'https://www.instagram.com/_jadhavakash_?igsi=MWMxMDFmZmQybnQ4', color: 'hover:text-violet-500' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
          ...
          >
            <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <h3 className="text-2xl font-black text-white tracking-tighter uppercase italic">
                AKASH<span className="text-cyan-600"> JADHAV</span>
              </h3>
            </div>
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 bg-gradient-to-r from-cyan-600 to-blue-800 text-black font-black text-[10px] uppercase tracking-[0.5em] rounded-xl shadow-[0_10px_30px_rgba(6,182,212,0.2)] flex items-center justify-center space-x-3 group overflow-hidden relative cursor-pointer"
            >
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end">
             ...
             <p className="text-[9px] text-gray-700 tracking-[0.2em] font-mono uppercase">
                &copy; AKASH JADHAV. ALL RIGHTS ARE RESERVED.
             </p>
          </div>
        </div>
      </div>
